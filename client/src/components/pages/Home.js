          ...
          <div>
            <div className="home-general-search-container">
              <aside>
                ...
                ></img>
                <p>
                  Explore by zipcode or address to reveal who the top
                  speculators in your area are.
                </p>
              </aside>
              <aside>
                ...
                ></img>
                <p>
                  Search a speculator by name to reveal the properties they own
                  in the Detroit area.
                </p>
              </aside>
              <aside>
            ...
            <div className="home-description">
              <aside>
                <p>
                  Blight and abandonment are active process. This site shows
                  part of that process. It maps bulk ownership and speculation
                  in the city. It identifies the owners and members of limited
                  liability companies holding multiple properties across the
                  city. Over the last decade speculation has further damaged
                  Detroit’s struggling neighborhoods and made life difficult for
